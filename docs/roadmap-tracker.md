...
| 4 | [#25](https://github.com/lambdaclass/tekton/issues/25) | Fine-grained tool approval UX | **Done** (covered by existing deny/allow in policy engine) | #24 |
...
| Issue | Title | Status |
|-------|-------|--------|
| [#39](https://github.com/lambdaclass/tekton/issues/39) | Conversational threads | **Done** |
